...
import { getPlanRunTimeline } from '../api/audit'
  ...
  <section class="page-stack">
    <header class="page-header">
      <div>
        ...
        <p class="page-eyebrow">PlanRun Timeline</p>
        <h1>{{ scopeId }}</h1>
        <p class="page-description">Plan lifecycle with related approvals, steps, jobs, and executions.</p>
      </div>
    </header>
    <AuditTimeline :scope-id="scopeId" :loader="getPlanRunTimeline" />
  </section>
</template>
